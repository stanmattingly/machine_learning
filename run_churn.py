...
from models.ChurnModel import ChurnModel
...
churn_model = ChurnModel().to(device)
...
train_model(churn_model, 150000, loss_fn, optimizer, X_train, y_train, X_test, y_test, torch.sigmoid, torch.round, True, scheduler)

torch.save(churn_model, "churn_model_v2.pt")